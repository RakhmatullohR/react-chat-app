      ...
      <div className='flex flex-col gap-10 w-[80vw] md:w-max'>
        ...
        <div className='grid grid-cols-2'>
          ...
          >
            ...
            {hovered ? (
              <div
                className='absolute inset-0 flex items-center justify-center bg-black/50 rign-fuchsia-50 rounded-full'
        ...
        <div className='w-full'>
          <Button
            className='h-16 w-full bg-purple-700 hover:bg-purple-900 transition-all duraton-300'
            onClick={saveChanges}
          >
            Save Changes
          </Button>
